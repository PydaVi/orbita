...
**Beta 0 through Beta 8 — done ✅** (2026-07-15 through 2026-07-19). End to end, against the real network: OAuth login, authenticated write and delete, sync via Tap against the production relay, cross-account aggregation, a real TMDB-backed search, season/episode-level catalog browsing, notes anchored to a work or to a specific episode, a real interface (no more raw HTML strings) with resolved handles/avatars instead of raw DIDs, a persistent site shell (topbar, navigation), a real profile page for any account by handle, a three-tab feed (Shelf, Following, Affinity-pending) with real reply threads and reposts on notes (attributed, never counted — no popularity metrics anywhere), **nooks** (Beta 7): a person's own, freely-ordered, cross-media groupings of their shelf, the primary way it's organized and shown to visitors, and — as of Beta 8 — a **constellation and archetype** on every profile: a from-scratch force layout anchored on each nook's own theme (not genre/tags — this catalog never built that pipeline), and a nine-name geometric signature derived from the same shape. See [`docs/BETA0-PLAN.md`](docs/BETA0-PLAN.md), [`docs/BETA1-PLAN.md`](docs/BETA1-PLAN.md), [`docs/BETA2-PLAN.md`](docs/BETA2-PLAN.md), [`docs/BETA3-PLAN.md`](docs/BETA3-PLAN.md), [`docs/BETA4-PLAN.md`](docs/BETA4-PLAN.md), [`docs/BETA5-PLAN.md`](docs/BETA5-PLAN.md), [`docs/BETA6-PLAN.md`](docs/BETA6-PLAN.md), [`docs/BETA7-PLAN.md`](docs/BETA7-PLAN.md), and [`docs/BETA8-PLAN.md`](docs/BETA8-PLAN.md), which document the whole process, not just the outcome.
